...
<body class="bg-gray-100 font-sans">
    ...
    <div class="movie-header bg-white shadow rounded-lg p-6 m-6 flex">
        <img src="Images/joker.jpg" alt="Interstellar Movie Poster" class="w-64 h-auto rounded-md shadow-md">
        <div class="details ml-6">
            <h1 class="text-2xl font-bold text-gray-800">Joker
                <a href="reviewJoker.jsp" class="ml-4 px-4 py-2 bg-blue-500 text-white rounded-md shadow hover:bg-blue-600">Review</a>
            </h1>
            <div class="synopsis mt-4">
                <h2 class="text-xl font-semibold text-gray-700">Sinopsis :</h2>
                <p>Arthur Fleck adalah seorang pria yang berjuang dengan gangguan mental sambil bekerja sebagai badut untuk menyambung hidup. Ia menghadapi penghinaan dan kekerasan dari masyarakat yang acuh tak acuh, yang semakin mendorongnya ke jurang keputusasaan. Seiring waktu, Arthur perlahan kehilangan pegangannya pada kenyataan dan bertransformasi menjadi Joker, simbol kekacauan di kota Gotham. Film ini adalah eksplorasi mendalam tentang isolasi, trauma, dan konsekuensi dari ketidakpedulian sosial.</p>
            </div>
            <!-- Watchlist Button -->
            <form action="addToWatchlist" method="POST" class="mt-6">
                <input type="hidden" name="filmId" value="4"> <!-- Film ID for Interstellar -->
                <% 
...
<div class="recommended-movies bg-white shadow rounded-lg p-6 m-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
        ...
        <a href="ShutterIsland.jsp" class="movie-item hover:shadow-lg text-center text-center">
            <img src="Images/shutter-island.jpg" alt="Shutter Island Movie Poster" class="w-58 h-auto mx-auto ">

...
<body>
                    ...
                    <div id="film-<%= film.get("id") %>" class="movie-card bg-white rounded-lg overflow-hidden shadow-md border border-gray-200 hover:border-primary hover:shadow-lg transition-all duration-300">
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center pt-4 border-t border-gray-200">
                                <a href="watch.jsp?id=<%= film.get("id") %>" 
                                   class="bg-primary text-white px-4 py-2 rounded-md hover:bg-red-700 transition-colors duration-300">
                                    Watch Now
                                </a>
                                <a href="film-details.jsp?id=<%= film.get("id") %>" 
                                   class="text-gray-600 hover:text-gray-900 border border-gray-300 px-4 py-2 rounded-md hover:border-gray-400 transition-colors duration-300">
                                    Details
                                </a>
                            </div>
                        </div>
    ...
    <script>
        // Updated removeFromWatchlist function with better error handling
        function removeFromWatchlist(filmId) {
            ...
            .then(data => {
                if (data.success) {
                    const element = document.getElementById('film-' + filmId);
                    if (element) {
                        element.remove();
            ...
            .catch(error => {
                ...
                alert('An error occurred while removing the film from watchlist');
            });
        }
    </script>
</body>

...
<body class="bg-gray-100 font-sans">
    ...
    <div class="movie-header bg-white shadow rounded-lg p-6 m-6 flex">
        <img src="Images/back-to-future.jpg" alt="Interstellar Movie Poster" class="w-64 h-auto rounded-md shadow-md">
        <div class="details ml-6">
            ...
            <form action="addToWatchlist" method="POST" class="mt-6">
                <input type="hidden" name="filmId" value="2"> <!-- Film ID for Interstellar -->
                <% 
